...
En el caso de la prueba Chi-Cuadrado todos los casos analizados obtuvieron un p-valor menor a 0.05, por lo que se rechaza la hipótesis nula y por ende, se acepta el criterio de que son variables dependientes. De esta manera se responde al segundo objetivo de la investigación.
Por ejemplo, con un nivel de confianza del 95 % se afirma que la condición de tener hijos o no está
asociado al nivel educativo de las mujeres desocupadas. También, que el estado conyugal de la mujer
con hijos está vinculado con su jornada de trabajo.

En cuanto a los resultados de la V de Cramer y del Coeficiente de Contingecia de Pearson resulta evidente variedad en los niveles de dependencia. Se puede ver que existe una relación alta entre la edad de la mujer y la condición de tener hijos o no y entre la edad de la mujer y la edad de los hijos. No obstante, contrario a lo observado en otros estudios, la jornada laboral muestra una relación débil con la condición de tener hijos o no. Esto puede suceder debido a que los mayores porcentajes de mujeres ocupadas con hijos son aquellas con edades de 45 años o más, a esto se le añade el hecho de que en este intervalo se encuentra dentro del grupo de edad de las madres con hijos de 15 años o más
el cual, también representa los porcentajes más altos. Por lo tando, al tener hijo con una edad de mayor independencia, la incidencia que estos puedan tener en el empleo de las madres es menor.
